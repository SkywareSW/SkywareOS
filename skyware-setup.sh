...
sudo pacman -Syu --noconfirm \
  flatpak cmatrix fastfetch btop zsh alacritty kitty curl git
...
# Delete any old Starship configs that might cause warnings
...
# Minimal Starship config compatible with latest versions
...
echo "→ btop themed"
echo "→ Starship zsh prompt enabled (no warnings)"
echo "→ Alacritty + Kitty dark-gray themed"
echo "→ Flatpak apps installed"
echo "Log out or reboot required for zsh/starship"
